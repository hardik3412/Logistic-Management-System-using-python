...
class add_book:
    def __init__(self, root):
        self.f = Frame(root.title("Delete inventory"), height=500, width=800, bg='dodgerblue3')

        self.f.propagate(0)

        self.f.pack()

        self.n = Label(text='DELETE INVENTORY', fg="black", bg="dodgerblue3", font=('Calibri Bold', 26))
    ...
    def buttonclick(self):
        ...
        sql_delete_order = "DELETE FROM inventory WHERE name = %s"
